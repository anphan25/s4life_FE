...
export function CloseIcon(props) {
  return <Icon icon="times" {...props} />;
}

// StarIcon
export function StarIcon(props) {
  return <Icon icon="solid-star" {...props} />;
}

// Using for Alert
export function InfoIcon(props) {
  return <Icon icon={'solid-info-circle'} {...props} />;
}

export function WarningIcon(props) {
  return <Icon icon={'solid-triangle-exclamation'} {...props} />;
}

export function SuccessIcon(props) {
  return <Icon icon={'solid-check-square'} {...props} />;
}

export function ErrorIcon(props) {
  return <Icon icon={'solid-times-square'} {...props} />;
}
...
export function CheckboxIndeterminateIcon(props) {
  return <Icon icon="solid-minus-square" {...props} />;
}
